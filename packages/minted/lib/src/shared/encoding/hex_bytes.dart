...
///
/// Assumes an even number of hex digits, which is what a validated hex value holds. An odd count
/// is a caller bug, and throws where the last pair runs off the end.
