...
///
/// Not check-digit-specific: every check-digit algorithm decodes with it, and so does `Digits`.
...
///
/// Assumes `0`-`9`, which is what a validated digit sequence holds. Only rendering needs this
/// direction.
