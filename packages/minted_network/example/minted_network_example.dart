...
void main() {
  ...
  print(
    mac == MacAddressConstants.ianaDocumentation,
  ); // true (RFC 9542's documentation address, named)
  // #endregion
  ...
  // #region port
  print(PortConstants.httpAlt.value); // 8080
  print(PortConstants.httpAlt.range); // PortRange.user
  print(PortConstants.https.range); // PortRange.system  (well-known)
  print(PortConstants.wildcard.isWildcard); // true  (bind(0) asks the OS for a free port)
