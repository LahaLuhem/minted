...
part 'constants/latitude_constants.dart';

/// A latitude in decimal degrees, `-90` to `90`. Negative is south of the equator.
///
/// A door taking one can't be handed an impossible degree, nor a [Longitude]. The swap is the bug no
/// range check catches, and this is where it stops compiling. A negative zero is cleared.
///
/// Named values: [LatitudeConstants].
extension type const Latitude._(double value) implements double {
  /// The [Latitude] of [degrees], or `null` outside `-90` to `90`. A `NaN` is outside, the bound being
