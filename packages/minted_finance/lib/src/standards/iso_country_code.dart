...
///
/// Borrowed rather than tabulated, because a list owned here would ship a clock
/// (`/APPENDIX.md#registry-data-ships-a-clock`). Alpha-2 only, so `GBR` is no country here even
/// though `country_code` resolves it. Kosovo is the one addition.
